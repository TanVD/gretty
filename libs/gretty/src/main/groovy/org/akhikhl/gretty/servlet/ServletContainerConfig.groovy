 ...
 */
package org.akhikhl.gretty.servlet

import groovy.transform.CompileStatic
import groovy.transform.TypeCheckingMode
import org.akhikhl.gretty.Externalized
...
class ServletContainerConfig {
    ...
    private static void addRedirectFilter(Project project) {
